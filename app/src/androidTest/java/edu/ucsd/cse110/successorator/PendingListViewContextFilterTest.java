...
public class PendingListViewContextFilterTest {
    ...
    @Test
    public void pendingListViewContextFilterTest() {
        ...
        ViewInteraction appCompatEditText3 = onView(
                allOf(withId(R.id.edit_text_task),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText3.perform(replaceText("Work 2"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText4 = onView(
                allOf(withId(R.id.edit_text_task),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText4.perform(replaceText("School 1"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText5 = onView(
                allOf(withId(R.id.edit_text_task),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText5.perform(replaceText("Errand 1"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText7 = onView(
                allOf(withId(R.id.edit_text_task),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText7.perform(replaceText("Home 2"), closeSoftKeyboard());
        ...
        ViewInteraction appCompatEditText8 = onView(
                allOf(withId(R.id.edit_text_task),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText8.perform(replaceText("Errand 2"), closeSoftKeyboard());
