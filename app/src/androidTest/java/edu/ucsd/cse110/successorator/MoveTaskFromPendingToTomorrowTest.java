...
public class MoveTaskFromPendingToTomorrowTest {
    ...
    @Test
    public void moveTaskFromPendingToTomorrowTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.edit_text_task),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("Test to Move"), closeSoftKeyboard());
